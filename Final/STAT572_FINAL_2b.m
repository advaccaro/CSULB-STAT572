%STAT572_FINAL_2b.m
%Adam Vaccaro
%NOTE: This script uses custom function LIK_RATIO.m
%Purpose: (geyser data) We have used the finite mixture method to estimate 
% the density of the geyser data. dN(mu1,sig1^2) + (1-d)*N(mu2,sig2^2).
...
%% Use M-H sampler to generate MC of size 1000
n = 1000;
%strg = '(d/sqrt(2*pi*var1))^n * exp(-(1/(2*var1))*sum(
